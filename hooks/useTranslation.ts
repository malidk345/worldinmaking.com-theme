...
const translations: Record<string, Record<TranslationKey, string>> = {
  ...
  tr: {
    ...
    'login.magic_sent_to': 'sihirli giriş bağlantısını şuraya gönderdik:',
    ...
    'login.send_link': 'sihirli bağlantı gönder',
    'login.secure_system': 'güvenli erişim sistemi',
    'login.failed': 'giriş başarısız',
    'login.magic_sent_success': 'sihirli bağlantı gönderildi. gelen kutunuzu kontrol edin.',
