                ...
                <PageWindow id="profile-window" title="profile" onClose={handleClose}>
                    <div className="flex-1 flex items-center justify-center bg-bg-3000 h-full">
                        <div className="text-center p-8">
                            ...
                            >
                                <span className="LemonButton__chrome px-4 py-2 bg-[#254b85] hover:bg-[#335d9d] text-white border border-[#254b85] rounded font-bold text-xs transition-all">
                                    sign in
                                </span>
                            </button>
                        </div>
        ...
        <div className="flex-1 flex flex-col h-full overflow-hidden">
            ...
            <PageWindow id="profile-window" title="profile" onClose={handleClose}>
                <div className="flex-1 overflow-y-auto bg-bg-3000 custom-scrollbar h-full" style={{ paddingBottom: 'calc(80px + env(safe-area-inset-bottom, 0px))' }}>
                    <div className="max-w-3xl mx-auto px-4 md:px-6 py-6 md:py-8">
                        ...
                        <div className="bg-white border border-[var(--border-primary)] rounded-lg p-4 mb-4 transition-all">
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                <div className="flex items-center gap-3">
                                    <div className="relative group">
                                        <div className="w-12 h-12 md:w-14 md:h-14 rounded-md border border-[var(--border-primary)] overflow-hidden bg-white flex-shrink-0 flex items-center justify-center text-primary text-xl font-bold select-none">
                                            {profile?.avatar_url ? (
                                                <UserAvatar
                                        ...
                                        <button
                                            ...
                                            className="absolute -bottom-1 -right-1 p-1 bg-white border border-[var(--border-primary)] rounded-md hover:bg-black/5 transition-all opacity-0 group-hover:opacity-100 z-10"
                                        >
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    >
                                        <span className="LemonButton__chrome px-3 py-1.5 border border-[var(--border-primary)] rounded font-bold text-xs text-secondary hover:text-primary hover:bg-black/5 bg-white transition-all text-center w-full sm:w-auto">
                        ...
                        <div className="flex items-end gap-1 overflow-x-auto no-scrollbar">
                            {tabs.map((tab) => (
                                <button
                                    ...
                                    className={`LemonButton px-4 md:px-5 py-1.5 md:py-2 text-[11px] font-bold transition-all relative rounded-t-md border-x border-t border-[var(--border-primary)] whitespace-nowrap ${activeTab === tab
                                            ? 'bg-white translate-y-[1px] z-10 text-primary'
                        ...
                        {/* Content Panel */}
                        <div className="bg-white border border-[var(--border-primary)] rounded-b-lg rounded-tr-lg p-4 md:p-6">
                            {activeTab === 'bio' ? (
                                <div>
                                ...
                                <div className="flex flex-col items-center justify-center py-12 md:py-16 text-center">
                                    <div className="w-14 h-14 bg-white border border-[var(--border-primary)] rounded-lg flex items-center justify-center mb-4">
                                        <svg className="w-7 h-7 text-secondary" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
                                            <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" />
                                        </svg>
                                    </div>
                                    <h3 className="font-bold text-base mb-1">{activeTab} empty</h3>
                                    <p className="text-secondary text-[11px] font-medium max-w-[200px]">no items found in your collection.</p>
                                </div>
                            )}
                        </div>
            ...
            {isPhotoModalOpen && (
                <div className="fixed inset-0 bg-white/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="w-full max-w-xs bg-white border border-[var(--border-primary)] rounded-lg p-5 shadow-lg">
                        ...
                        <div className="relative mb-4">
                            ...
                            <input
                                ...
                                type="text"
                                placeholder="https://..."
                                className="w-full bg-white border border-[var(--border-primary)] rounded-md pl-9 pr-3 py-2 text-sm outline-none focus:border-primary transition-colors"
                                value={tempPhotoUrl}
                        ...
                        <div className="flex gap-2">
                            ...
                            >
                                <span className="LemonButton__chrome py-2 border border-[var(--border-primary)] rounded font-bold text-xs text-secondary hover:text-primary hover:bg-black/5 bg-white transition-all w-full justify-center">
                                    cancel
                                </span>
                            </button>
                            <button
                            ...
                            >
                                <span className="LemonButton__chrome py-2 bg-[#254b85] hover:bg-[#335d9d] text-white border border-[#254b85] rounded font-bold text-xs transition-all w-full justify-center">
                                    save
                                </span>
                            </button>
                        </div>
