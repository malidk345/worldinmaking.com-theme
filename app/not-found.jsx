...
export default function NotFound() {
    return (
        <div
            className="flex-1 flex items-center justify-center bg-bg-3000 p-6 min-h-screen"
            role="main"
            aria-labelledby="not-found-title"
        >
            <div className="max-w-md w-full text-center">
                {/* 404 */}
                <div className="text-8xl font-black text-gray-200 dark:text-gray-800 mb-4" aria-hidden="true">
                    404
                </div>

                {/* Message */}
                <h1 id="not-found-title" className="text-2xl font-bold text-primary mb-2">
                    page not found
                </h1>
                ...
                {/* Suggestions */}
                <nav
                    className="mb-8 p-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl"
