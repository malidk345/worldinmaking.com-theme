...
export default function Error({ error, reset }) {
    ...
    return (
        <div className="flex-1 flex flex-col h-full overflow-hidden">
            <DashboardHeader />
            <main className="flex-1 flex items-center justify-center bg-bg-3000 p-6">
                <div className="max-w-md w-full text-center">
                    {/* Error Icon */}
                    <div className="w-16 h-16 mx-auto mb-6 bg-red-50 rounded-full flex items-center justify-center border border-red-100">
                    ...
                    {/* Error Message */}
                    <h2 className="text-xl font-bold text-primary mb-2">oops, something went wrong</h2>
