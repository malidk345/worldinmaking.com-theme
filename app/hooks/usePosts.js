...
const postsFetcher = async ({ fetchContent = false } = {}) => {
...
export const usePosts = ({ fetchContent = false } = {}) => {
    const { data, error, isLoading, mutate } = useSWR(['posts', { fetchContent }], (arg1, arg2) => {
        // SWR 2.x passes key as first argument (array), SWR 1.x passes spread arguments
        const opts = Array.isArray(arg1) ? arg1[1] : arg2;
        return postsFetcher(opts);
    }, {
