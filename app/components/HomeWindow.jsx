                ...
                <AnimatePresence>
                    {showCategories && (
                        <motion.aside
                            ...
                            className="absolute left-4 top-4 w-[200px] z-60 bg-white/90 backdrop-blur-xl rounded-xl shadow-2xl overflow-hidden flex flex-col border border-black/15"
                        >
                ...
                <AnimatePresence>
                    {showFilter && (
                        <motion.aside
                            ...
                            exit={{ opacity: 0, scale: 0.95, y: -10 }}
                            transition={{ duration: 0.2, ease: "easeOut" }}
                            className="absolute left-4 top-4 w-[250px] z-60 bg-white/90 backdrop-blur-xl rounded-xl shadow-2xl overflow-hidden flex flex-col border border-black/15"
                        >
                            <div className="px-3 py-2 border-b border-black/15 flex items-center justify-between bg-white/50">
