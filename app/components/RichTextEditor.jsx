...
const Toolbar = ({ mode, setMode, onAction }) => {
    ...
    return (
        <div className="flex items-center justify-between border-b border-black/15 px-2 py-1.5 bg-[#f9fafb]">
            <div className="flex items-center gap-0.5 overflow-x-auto py-0.5">
                <ToolBtn
                    icon={<svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M6 4h8a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z" /><path d="M6 12h9a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z" /></svg>}
                    action="bold"
                    title="Bold"
                />
                <ToolBtn
                    icon={<svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><line x1="19" x2="10" y1="4" y2="4" /><line x1="14" x2="5" y1="20" y2="20" /><line x1="15" x2="9" y1="4" y2="20" /></svg>}
                    action="italic"
                    title="Italic"
                />
                <ToolBtn
                    icon={<svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M16 4H9a3 3 0 0 0 0 6h7" /><path d="M15 10H9a3 3 0 0 0 0 6h6" /></svg>}
                    action="strikeThrough"
                    title="Strikethrough"
                />
                <div className="w-px h-4 bg-black/10 mx-1.5" />
                <ToolBtn
                    icon={<svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><line x1="8" x2="21" y1="6" y2="6" /><line x1="8" x2="21" y1="12" y2="12" /><line x1="8" x2="21" y1="18" y2="18" /><line x1="3" x2="3.01" y1="6" y2="6" /><line x1="3" x2="3.01" y1="12" y2="12" /><line x1="3" x2="3.01" y1="18" y2="18" /></svg>}
                    action="insertUnorderedList"
                    title="Bullet List"
                />
                <ToolBtn
                    icon={<svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><line x1="10" x2="21" y1="6" y2="6" /><line x1="10" x2="21" y1="12" y2="12" /><line x1="10" x2="21" y1="18" y2="18" /><path d="M4 6h1v4" /><path d="M4 10h2" /><path d="M6 18H4c0-1 2-2 2-3s-1-1.5-2-1" /></svg>}
            ...
            <div className="flex items-center bg-white border border-black/15 rounded overflow-hidden shrink-0 ml-2">
                <button
                    type="button"
