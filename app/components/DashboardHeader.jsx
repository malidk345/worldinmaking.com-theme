                    ...
                    <div className="relative mr-2 self-end h-[28px] flex items-center">
                        ...
                        {isTabManagerOpen && (
                            <>
                                ...
                                <div className="absolute top-full left-0 mt-2 w-72 bg-white border border-stone-200 rounded-xl shadow-2xl z-50 overflow-hidden">
                                    {/* Header */}
                                    ...
                                    {history && history.length > 0 && (
                                        <>
                                            <div className="px-2 py-1.5 bg-stone-50/50 border-t border-b border-stone-100">
                                                <span className="text-[10px] font-bold text-stone-400 uppercase tracking-wider">
