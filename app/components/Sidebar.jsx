...
const Sidebar = () => {
    ...
    // Close handler - closes both mobile and desktop
    const handleClose = () => {
        closeMobileSidebar();
        closeSidebar();
    };

    // Link click handler - closes sidebar after navigation
    const handleLinkClick = () => {
        closeMobileSidebar();
        // Optionally close desktop sidebar on link click too
        // closeSidebar();
    };
        ...
        <>
            ...
            >
                ...
                <div className="relative flex items-center justify-center px-1" style={{ height: 'var(--scene-layout-header-height)' }}>
                    ...
                    {/* Right Icon (Close) - Always visible */}
                    <button
