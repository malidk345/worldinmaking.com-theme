...
export default function Dashboard() {
    ...
    return (
        <div className="Dashboard w-full h-full flex flex-col min-h-0">
            ...
            {/* Main Content Area */}
            <div
                className="Dashboard__content flex-1 w-full min-h-0 relative overflow-y-auto overflow-x-hidden"
            ...
            >
                ...
                <AnimatePresence>
                    {showCategories && (
                        <motion.aside
                            {...panelAnimation}
                            className="fixed left-4 top-[calc(var(--scene-layout-header-height)+60px)] w-[200px] z-60 bg-white/90 backdrop-blur-xl rounded-xl shadow-2xl overflow-hidden flex flex-col border border-black/15"
                            role="dialog"
                ...
                <AnimatePresence>
                    {showFilter && (
                        <motion.aside
                            {...panelAnimation}
                            className="fixed left-4 top-[calc(var(--scene-layout-header-height)+60px)] w-[250px] z-60 bg-white/90 backdrop-blur-xl rounded-xl shadow-2xl overflow-hidden flex flex-col border border-black/15"
                            role="dialog"
                            ...
                            <div className="p-3 flex flex-col gap-3">
                                <div>
                                    <label
                                        ...
                                        className="text-[10px] font-bold text-secondary uppercase tracking-wider block mb-1.5"
                                    >
                                        category
                                    </label>
                                    <div className="relative">
                                        <select
                                            ...
                                            className="w-full appearance-none bg-white border border-black/20 rounded-lg py-2 pl-3 pr-8 text-xs font-medium text-primary focus:outline-none focus:border-black/30 transition-colors"
                                        >
                                            {categories.map(c => (
                            ...
                            <span className="text-[12px] font-semibold bg-black text-white px-2 py-0.5 rounded capitalize flex items-center gap-1">
                                ...
                                >
                                    <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M18.3 5.71a1 1 0 0 0-1.42 0L12 10.59 7.12 5.7a1 1 0 0 0-1.42 1.42L10.59 12l-4.88 4.88a1 1 0 1 0 1.42 1.42L12 13.41l4.88 4.88a1 1 0 0 0 1.42-1.42L13.41 12l4.88-4.88a1 1 0 0 0 0-1.41z" />
                                    </svg>
                                </button>
                            </span>
                        </div>
                        ...
                        <div className="flex flex-col gap-2">
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            <span className="text-[10px] text-secondary" aria-hidden="true">•</span>
                            ...
                            {filteredPosts.length === 0 && !loading && (
                                <div className="text-center py-12">
                                    <p className="text-secondary text-sm">No posts found for this category.</p>
                                </div>
                            )}
                        </div>
                    )}
