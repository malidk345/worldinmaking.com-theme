...
export default function NewPostToggler({ onPost }) {
    ...
    return (
        <>
            ...
            <div
                className={`
                    fixed z-50 bg-white border border-black/10 shadow-2xl
            ...
            <div className="fixed bottom-6 right-6 z-50">
                <button
                    ...
                    onClick={toggle}
                >
                    <span className="LemonButton__chrome flex items-center justify-center w-12 h-12 bg-white border border-black/10 rounded-xl font-bold text-secondary hover:text-primary hover:border-black/30 hover:bg-white transition-all shadow-xl">
                        <PlusIcon />
                    </span>
                </button>
            </div>
