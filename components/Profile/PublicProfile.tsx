...
import { LemonTag, LemonButton } from '@/components/LemonUI'
...
export default function PublicProfile({ username }: PublicProfileProps) {
    ...
    return (
        <div className="corpus-root flex flex-col size-full bg-white dark:bg-[#121214] text-primary font-sans overflow-hidden">
            <div
                                                ...
                                                <tbody>
                                                    {isEditingProfile ? (
                                                        <>
                                                            ...
                                                            <tr><td>pronouns</td><td><input type="text" value={form.pronouns || ''} onChange={(e) => setForm({ ...form, pronouns: e.target.value })} placeholder="she/her" className="w-full bg-gray-50 dark:bg-gray-900 rounded-full px-3 py-1.5 border border-black/10 dark:border-white/10 outline-none text-sm text-primary placeholder:text-primary/30 transition-all focus:bg-white dark:focus:bg-black focus:border-black/20 dark:focus:border-white/20" /></td></tr>
                                                            <tr><td>location</td><td><input type="text" value={form.location || ''} onChange={(e) => setForm({ ...form, location: e.target.value })} placeholder="istanbul, TR" className="w-full bg-gray-50 dark:bg-gray-900 rounded-full px-3 py-1.5 border border-black/10 dark:border-white/10 outline-none text-sm text-primary placeholder:text-primary/30 transition-all focus:bg-white dark:focus:bg-black focus:border-black/20 dark:focus:border-white/20" /></td></tr>
                                                            <tr><td>website</td><td><input type="text" value={form.website || ''} onChange={(e) => setForm({ ...form, website: e.target.value })} placeholder="https://your-site.com" className="w-full bg-gray-50 dark:bg-gray-900 rounded-full px-3 py-1.5 border border-black/10 dark:border-white/10 outline-none text-sm text-primary placeholder:text-primary/30 transition-all focus:bg-white dark:focus:bg-black focus:border-black/20 dark:focus:border-white/20" /></td></tr>
                                                            <tr><td>github</td><td><input type="text" value={form.github || ''} onChange={(e) => setForm({ ...form, github: e.target.value })} placeholder="https://github.com/username" className="w-full bg-gray-50 dark:bg-gray-900 rounded-full px-3 py-1.5 border border-black/10 dark:border-white/10 outline-none text-sm text-primary placeholder:text-primary/30 transition-all focus:bg-white dark:focus:bg-black focus:border-black/20 dark:focus:border-white/20" /></td></tr>
                                                            <tr><td>linkedin</td><td><input type="text" value={form.linkedin || ''} onChange={(e) => setForm({ ...form, linkedin: e.target.value })} placeholder="https://linkedin.com/in/username" className="w-full bg-gray-50 dark:bg-gray-900 rounded-full px-3 py-1.5 border border-black/10 dark:border-white/10 outline-none text-sm text-primary placeholder:text-primary/30 transition-all focus:bg-white dark:focus:bg-black focus:border-black/20 dark:focus:border-white/20" /></td></tr>
                                                            <tr><td>twitter</td><td><input type="text" value={form.twitter || ''} onChange={(e) => setForm({ ...form, twitter: e.target.value })} placeholder="https://x.com/username" className="w-full bg-gray-50 dark:bg-gray-900 rounded-full px-3 py-1.5 border border-black/10 dark:border-white/10 outline-none text-sm text-primary placeholder:text-primary/30 transition-all focus:bg-white dark:focus:bg-black focus:border-black/20 dark:focus:border-white/20" /></td></tr>
                                                            <tr><td>avatar</td><td><input type="text" value={form.avatar_url || ''} onChange={(e) => setForm({ ...form, avatar_url: e.target.value })} placeholder="https://example.com/photo.png" className="w-full bg-gray-50 dark:bg-gray-900 rounded-full px-3 py-1.5 border border-black/10 dark:border-white/10 outline-none text-sm text-primary placeholder:text-primary/30 transition-all focus:bg-white dark:focus:bg-black focus:border-black/20 dark:focus:border-white/20" /></td></tr>
                                                            <tr><td>cover</td><td><input type="text" value={form.cover_url || ''} onChange={(e) => setForm({ ...form, cover_url: e.target.value })} placeholder="https://example.com/cover.jpg" className="w-full bg-gray-50 dark:bg-gray-900 rounded-full px-3 py-1.5 border border-black/10 dark:border-white/10 outline-none text-sm text-primary placeholder:text-primary/30 transition-all focus:bg-white dark:focus:bg-black focus:border-black/20 dark:focus:border-white/20" /></td></tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <select
                                                                        ...
                                                                        className="w-full bg-gray-50 dark:bg-gray-900 rounded-full px-3 py-1.5 border border-black/10 dark:border-white/10 outline-none text-sm text-primary transition-all focus:bg-white dark:focus:bg-black focus:border-black/20 dark:focus:border-white/20 cursor-pointer"
                                                                    >
                                            ...
                                            {isEditingProfile ? (
                                                <div>
                                                    <textarea
                                                        ...
                                                        rows={4}
                                                        className="w-full resize-none bg-gray-50 dark:bg-gray-900 rounded-[24px] px-4 py-3 border border-black/10 dark:border-white/10 outline-none text-sm text-primary placeholder:text-primary/40 transition-all duration-300 ease-in-out focus:bg-white dark:focus:bg-black focus:border-black/20 dark:focus:border-white/20"
                                                        style={{ margin: 0, lineHeight: 1.6 }}
                                                    />
                                                    <div className="flex items-center justify-end gap-2 px-3 py-3 border-t border-primary/10">
                                                        <LemonButton htmlType="button" type="tertiary" status="alt" size="small" onClick={() => setIsEditingProfile(false)}>{t('profile.cancel')}</LemonButton>
