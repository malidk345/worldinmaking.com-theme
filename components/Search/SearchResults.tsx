                        ...
                        {hits.map((hit) => {
                            return (
                                ...
                                >
                                    ...
                                    >
                                        <span
                                            className={`text-[13px] font-normal ${hit.type === 'api' ? 'lowercase' : 'lowercase'
                ...
                {activeOption ? (
                    <div className="p-6 bg-white  rounded border border-primary/40 dark:">
                        <div className="text-left">
                            <span
                                className={`block text-sm font-semibold text-black/50 dark:text-white/50 lowercase mb-1`}
                            >
                                {activeOption.type}
                            </span>
                                ...
                                <ol className="list-none m-0 text-sm text-black/60 dark:text-white/60 font-semibold space-y-2">
                                    {activeOption?.schema?.map((endpoint, index) => {
                                        return (
                                            ...
                                            >
                                                <span className="lowercase">{endpoint.httpVerb}</span>
