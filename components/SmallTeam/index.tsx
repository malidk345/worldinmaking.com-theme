...
export default function SmallTeam({ slug, children, inline = false, noMiniCrest = false, className = '' }: SmallTeamProps): React.ReactNode | null {
        ...
        return (
            ...
            >
                <div className="text-center max-w-xs flex flex-col items-center">
                    {fullCrestUrl && (
                        <div className="inline-block size-24 rounded-lg overflow-hidden p-2 mb-2 relative">
                            <CloudinaryImage
                                src={fullCrestUrl}
                                alt={`${team.name} crest`}
                                fill
