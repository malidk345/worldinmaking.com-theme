...
export interface LemonTableColumn<T> {
  ...
  dataIndex?: keyof T
  key?: string
  render?: (value: any /* eslint-disable-line @typescript-eslint/no-explicit-any */, record: T, index: number) => React.ReactNode
}
...
export function LemonTable<T extends Record<string, any /* eslint-disable-line @typescript-eslint/no-explicit-any */>>({ columns, dataSource, loading, className }: LemonTableProps<T>): JSX.Element {
  return (
