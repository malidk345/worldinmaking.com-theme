        ...
        <AnimatePresence mode="wait">
            {!isOpen ? (
                <motion.div
                    ...
                    className={`p-1 flex items-center space-x-3 ${archived ? 'opacity-25 pointer-events-none' : ''}`}
                >
                    ...
                    >
                        <span className="font-bold text-sm text-primary/60 lowercase">reply...</span>
                    </button>
                </motion.div>
            ) : (
                <motion.div
                    ...
                    className={`relative bg-white/40 dark:bg-black/40 supports-[backdrop-filter]:backdrop-blur-[40px] rounded-[32px] p-4 border border-black/5 dark:border-white/5 shadow-[0_8px_32px_rgba(0,0,0,0.04)] overflow-hidden ${archived ? 'opacity-25 pointer-events-none' : ''}`}
                >
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            <ForumRichText
                                ...
                                className="bg-transparent min-h-[100px] lowercase px-2"
