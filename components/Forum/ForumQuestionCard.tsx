...
export default function ForumQuestionCard({
    ...
    return (
        <div className="flex flex-col w-full text-primary">
            ...
            <div className={`flex w-full gap-3 relative ${isInForum ? 'pt-4 px-4 pb-4 sm:pt-6 sm:pl-6 sm:pr-8 bg-transparent sm:bg-gray-50 sm:dark:bg-[#1C1C1E] border-none sm:border sm:border-primary/10 rounded-none sm:rounded-[24px] md:rounded-[32px] shadow-none sm:shadow-sm sm:shadow-black/5' : ''}`}>
