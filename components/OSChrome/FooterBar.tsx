...
export default function FooterBar({
    ...
    const content = (
        <div data-scheme="tertiary" className={`flex w-full items-center px-1.5 py-0.5 select-none gap-2 justify-between ${footerTarget ? 'bg-white dark:bg-[#121214]' : 'bg-primary border-t border-primary'}`}>
