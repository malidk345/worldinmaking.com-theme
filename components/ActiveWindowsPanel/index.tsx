    ...
    return (
        ...
        >
            <div className="h-full flex flex-col lowercase">
                        ...
                        {windows.map((w) => (
                            <div key={w.key} className="relative group">
                                <OSButton
                                    ...
                                    className="justify-between py-0.5 h-auto min-h-0 pr-6"
                                >
                                    <span className={`truncate flex-1 text-xs ${w.minimized ? 'italic opacity-60' : ''}`}>
                                        {w.title || 'untitled'}
                                    </span>
                                </OSButton>
                                <button
                                    ...
                                    className="absolute right-1 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-red-500 opacity-0 group-hover:opacity-100 transition-opacity p-1 z-10"
                                >
                                    <X className="size-3" />
                                </button>
                            </div>
                ...
                {totalWindows > 0 && (
                    <div className="p-2 mt-auto border-t border-primary bg-zinc-50 dark:bg-zinc-800/10">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            >
                                ...
                                <span className="text-primary-text">close all windows</span>
                            </OSButton>
                        </div>
                    </div>
                )}
