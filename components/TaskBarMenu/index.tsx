    ...
    return (
        <>
            <div
                ...
                id="taskbar"
                data-scheme="primary"
                className="w-full bg-white/80 dark:bg-black/80 supports-[backdrop-filter]:backdrop-blur-[60px] border-b border-primary top-0 z-[9999] flex justify-between pl-0.5 pr-2 items-center"
            >
