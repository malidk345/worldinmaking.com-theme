...
export default function TaskBarMenu({ isMaximized }: { isMaximized?: boolean }) {
    ...
    const accountMenu = React.useMemo(() => [
        {
            trigger: (
                <OSButton size="sm" className="px-1 overflow-hidden" aria-label={t('menu.profile')}>
    ...
    return (
        <>
            <LanguageSelector
                ...
                positionClass="fixed top-[42px] right-2 z-[30001]"
                ...
                <aside className="flex items-center gap-0 py-1">
                    ...
                    >
                        <Tooltip
                            ...
                            ), [totalWindows, handleActiveWindowsClick, t])}
                            delay={0}
                        >
                    ...
                    <Tooltip
                        trigger={
                            <OSButton onClick={() => openSearch()} size="sm" className="px-1 translate-y-[2px]" aria-label={t('search.tooltip')}>
