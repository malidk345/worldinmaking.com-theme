...
export function CommandPalette({
  ...
  const editorCommands: CommandItem[] = useMemo(() => {
    ...
    return [
      ...
      { id: 'callout-warning', label: 'Warning Callout', group: 'Insert Block', icon: <AlertTriangle size={15} className="text-amber-500"/>, action: ins(() => (editor.chain().focus() as any).setCallout({ type: 'warning' }).run()) },
