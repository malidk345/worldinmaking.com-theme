        ...
        <AnimatePresence mode="wait">
            {!isActive ? (
                <motion.div
                    ...
                    className={`p-1 flex items-center space-x-3 ${className}`}
                >
                ...
                <motion.div
                    ...
                    className={`relative bg-white/40 dark:bg-black/40 supports-[backdrop-filter]:backdrop-blur-[40px] rounded-[32px] p-4 border border-black/5 dark:border-white/5 shadow-[0_8px_32px_rgba(0,0,0,0.04)] overflow-hidden ${className}`}
                >
