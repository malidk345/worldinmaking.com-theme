...
export function NotebooksListSkeleton() {
  ...
  const columns: Column<NotebookListItemType>[] = [
    ...
    },
    {
      ...
      render: (created_at) => <span className="font-mono text-xs opacity-75">{created_at as string}</span>,
    },
    {
      title: 'Last modified',
      dataIndex: 'last_modified_at',
      render: (last_modified_at) => <span className="font-mono text-xs opacity-75">{last_modified_at as string}</span>,
    },
    {
      title: '',
      render: (_, notebook) => {
