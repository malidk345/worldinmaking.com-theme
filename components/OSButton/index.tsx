...
const OSButton = React.forwardRef<HTMLButtonElement | HTMLAnchorElement, OSButtonProps>(
    (
        ...
        const variantClasses = {
            ...
            primary: {
                parent: 'bg-[#243c5a] border-[#243c5a] text-primary text-center group disabled:opacity-50 disabled:cursor-not-allowed',
                child: 'flex items-center justify-center bg-[#3b6296] text-white border-[#243c5a] font-bold active:transition-all active:duration-100',
            },
            secondary: {
                parent: 'bg-navy dark:bg-button-secondary-shadow-dark text-primary border-navy dark:border-button-secondary-dark text-center group disabled:opacity-50 disabled:cursor-not-allowed',
                child: 'flex items-center justify-center bg-white dark:bg-dark text-primary dark:text-primary-dark border-navy dark:border-navy font-bold active:transition-all active:duration-100',
            },
            underline: 'underline border-transparent hover:no-underline !p-0',
            underlineOnHover: 'hover:underline border-transparent !p-0',
            ghost: 'bg-transparent border-transparent hover:bg-accent dark:hover:bg-accent',
        }
