...
export default function Team({
        ...
        onSubmit: async ({
            ...
            if (!team) {
                ...
                if (normalizedSlug !== slug) {
                    router.push(`/teams/${normalizedSlug}`)
                }
            }
            setSaving(false)
            setEditing(false)
    ...
    // ⚡ Bolt: Memoize team crest map to prevent O(N) recalculation on every render
    ...
    // ⚡ Bolt: Memoize filtered jobs to prevent parsing JSON in a tight loop on every render
