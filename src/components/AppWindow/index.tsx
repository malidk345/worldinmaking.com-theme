        ...
        >
            <WindowContainer closing={closing}>
                ...
                <motion.div
                    ...
                    className={`group @container absolute overflow-hidden pointer-events-auto !select-auto flex flex-col border transition-shadow duration-200 pb-[env(safe-area-inset-bottom)] ${
                        focusedWindow?.key === item.key
