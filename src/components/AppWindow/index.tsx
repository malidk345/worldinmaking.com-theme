        ...
        >
            <WindowContainer closing={closing}>
                ...
                <motion.div
                    ...
                    className={`focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 group @container absolute overflow-hidden pointer-events-auto !select-auto flex flex-col border transition-shadow duration-200 ${
                        focusedWindow?.key === item.key
