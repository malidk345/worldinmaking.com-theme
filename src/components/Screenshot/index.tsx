...
export const Screenshot = ({ icon, product, slug, order, src, className = '' }: ScreenshotProps): JSX.Element => {
    ...
    return (
        <svg
            ...
            className={`${className} rounded-md reasonable:max-h-full border border-transparent dark:border-dark/50`}
        >
            <g clipPath="url(#a)">
                {/* content frame */}
                ...
                <path stroke="#CE5347" strokeWidth=".5" d="M24.75 22a5.75 5.75 0 1 1-11.5 0 5.75 5.75 0 0 1 11.5 0Z" />
                <g filter="url(#d)">
                    <path
                        fill="#F6BE4F"
                        fillRule="evenodd"
                ...
                <path stroke="#D6A243" strokeWidth=".5" d="M44.75 22a5.75 5.75 0 1 1-11.5 0 5.75 5.75 0 0 1 11.5 0Z" />
                <g filter="url(#e)">
                    <path
                        fill="#62C554"
                        fillRule="evenodd"
                ...
                <path stroke="#58A942" strokeWidth=".5" d="M64.75 22a5.75 5.75 0 1 1-11.5 0 5.75 5.75 0 0 1 11.5 0Z" />
