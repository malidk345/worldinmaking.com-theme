...
export const SnippetThemeToggler = ({ theme }: { theme: 'light' | 'dark' }) => (
...
export const WindowIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
        <rect width="18" height="15" x="3" y="4.5" rx="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M3 9.5h18" strokeLinecap="round" strokeLinejoin="round" />
        <circle cx="6.5" cy="7" r="0.75" fill="currentColor" stroke="none" />
        <circle cx="9.5" cy="7" r="0.75" fill="currentColor" stroke="none" />
        <circle cx="12.5" cy="7" r="0.75" fill="currentColor" stroke="none" />
    </svg>
);

export const HeartIcon = ({ size = 20, filled = false }: { size?: number, filled?: boolean }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill={filled ? "currentColor" : "none"} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" style={{ width: size, height: size }}>
