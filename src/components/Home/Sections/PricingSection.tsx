...
We aim to match the cheapest option at scale – PostHog should be a no-brainer. You never have to "jump on a quick call" with sales.`}</Markdown>

        <Link href="/pricing" state={{ newWindow: true }}>
            Explore pricing
        </Link>
    </div>
)
