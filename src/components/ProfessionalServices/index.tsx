        ...
        <>
            ...
            >
                ...
                <p className="text-sm text-secondary text-center @xl:text-left mb-12">
                    ...
                    <Link href="/merch?product=30-min-onboarding-consultation" state={{ newWindow: true }}>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <Link href="/baa" state={{ newWindow: true }}>
                            BAA
                        </Link>{' '}
                        and{' '}
                        <Link href="/dpa" state={{ newWindow: true }}>
                            DPA
                        </Link>{' '}
                        generators
                    </li>
