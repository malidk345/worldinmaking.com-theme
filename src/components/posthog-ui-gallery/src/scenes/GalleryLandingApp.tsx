            ...
            <div style={{ maxWidth: '960px', margin: '0 auto' }}>
                ...
                <div style={{ marginBottom: '2.5rem' }}>
                    ...
                    <p style={{ margin: 0, fontSize: '1rem', color: 'var(--color-text-secondary)', lineHeight: 1.5 }}>
                        Standalone React 1:1 component replicas extracted directly from PostHog&apos;s Storybook and
                        production codebase.
                    </p>
                </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        ...
                        >
                            <div>
                                ...
                                <div style={{ fontSize: '0.875rem', color: 'var(--color-text-secondary)' }}>
                                    Storybook: <code>Scenes-App/Notebooks → Notebooks List</code> (LemonTable with
                                    sorting, avatars, search input &amp; scroll shadows)
                                </div>
                            </div>
                        ...
                        >
                            <div>
                                ...
                                <div style={{ fontSize: '0.875rem', color: 'var(--color-text-secondary)' }}>
                                    Storybook: <code>Scenes-App/Notebooks → Text-Only Notebook</code> (Full editor
                                    document view with editable title, ProseMirror paragraphs &amp; top action bar)
                                </div>
                            </div>
                        ...
                        >
                            <div>
                                ...
                                <div style={{ fontSize: '0.875rem', color: 'var(--color-text-secondary)' }}>
                                    Storybook: <code>Scenes-App/SidePanels → Side Panel Notebooks</code> (Right-side
                                    3000 context panel drawer with notebook editor &amp; popovers)
                                </div>
                            </div>
                        ...
                        >
                            <div>
                                ...
                                <div style={{ fontSize: '0.875rem', color: 'var(--color-text-secondary)' }}>
                                    Storybook: <code>Scenes-App/Discussions → Threads</code> (Interactive team comments,
                                    reactions, status badges &amp; rich composer)
                                </div>
                            </div>
                        ...
                        >
                            <div>
                                ...
                                <div style={{ fontSize: '0.875rem', color: 'var(--color-text-secondary)' }}>
                                    Storybook: <code>Scenes-App/PostHog AI → Thread</code> (Max AI assistant chat, HogQL
                                    query executions, chart visualizer &amp; prompts)
                                </div>
                            </div>
                        ...
                        >
                            <div>
                                ...
                                <div style={{ fontSize: '0.875rem', color: 'var(--color-text-secondary)' }}>
                                    Storybook: <code>Lemon UI/*</code> (LemonButton, LemonInput, LemonSelect, LemonTag,
                                    LemonBadge, LemonBanner, LemonTabs, LemonSwitch)
                                </div>
                            </div>
