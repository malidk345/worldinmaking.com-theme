...
export function SidePanelNotebooksApp({ onBack }: SidePanelNotebooksAppProps): JSX.Element {
    ...
    const filteredNotebooks = notebookList.filter((n) => n.title.toLowerCase().includes(searchQuery.toLowerCase()))
                ...
                >
                                ...
                                >
                                    {filteredNotebooks.map((nb) => (
                                        <LemonButton
                                            ...
                                            type="tertiary"
                                            sideIcon={
                                                <ProfilePicture name={nb.user} email="paul@posthog.com" size="xs" />
                                            }
                                            fullWidth
                                            onClick={() => {
                    ...
                    >
                        ...
                        <LemonButton
                            ...
                            type="tertiary"
                            icon={<IconExpand45 />}
                            aria-label="Open as main focus"
                            title="Open as main focus"
                        />
                        {onBack && (
                            <LemonButton
                                size="small"
