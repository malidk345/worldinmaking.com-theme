...
import { LemonButton, LemonInput, ProfilePicture, LemonTextArea } from '../components/lemon-ui'
            ...
            replies: [
                {
                    ...
                    comment: {
                        ...
                        content:
                            'Checking Temporal worker logs now. Looks like payload cap hit ~2.1MB on team_id 2 during precompute.',
                ...
                },
                {
                    ...
                    comment: {
                        ...
                        content:
                            'Fixed the activity payload serialization in PR #4821 by storing results to SeaweedFS by reference.',
                ...
                >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.25rem', flexWrap: 'wrap' }}>
                        {Object.entries(comment.reactions).map(([emoji, list]) => (
                            ...
                            >
                                <span>{emoji}</span>
                                <span style={{ fontSize: '0.6875rem', fontWeight: 600, marginLeft: '0.25rem' }}>
                                    {list.length}
                                </span>
                            </LemonButton>
                        ))}
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <div style={{ display: 'flex', gap: '0.25rem' }}>
                                <LemonButton
                                    size="xsmall"
                                    type="tertiary"
                                    onClick={() => onSetInlineReplyText(inlineReplyText + ' 👍')}
                                >
                                    👍
                                </LemonButton>
                                <LemonButton
