            ...
            commentReplies: [
                {
                    ...
                    author: 'James Green',
                    avatar: 'JG',
                    text: 'SeaweedFS gRPC payload limit might be hit during high-throughput activity spikes.',
                    time: '2 hours ago',
                },
                {
                    id: 'cr-2',
                    author: 'Alex Smith',
                    avatar: 'AS',
                    text: 'Investigating Temporal worker execution logs on prod-eu right now.',
                    time: '1 hour ago',
                },
            ],
        },
            ...
            >
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        ...
                        <span style={{ fontSize: '0.8125rem', color: 'var(--color-text-secondary)' }}>Notebooks /</span>
            ...
            <div style={{ display: 'flex', flex: 1 }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                            {blocks.map((block, index) => (
                                <NotebookBlockRow
                                    ...
                                    onOpenSlashMenu={() =>
                                        setActiveSlashBlockId(activeSlashBlockId === block.id ? null : block.id)
                                    }
                ...
                {showHistoryDrawer && (
                    ...
                    >
                        ...
                        <div
                            style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', fontSize: '0.8125rem' }}
                        >
                            <div
                                style={{
                                    padding: '0.75rem',
                            ...
                            >
                                ...
                                <div style={{ color: 'var(--color-text-secondary)', fontSize: '0.75rem' }}>
                                    Edited by Paul D&apos;Amora • Just now
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <div style={{ color: 'var(--color-text-secondary)', fontSize: '0.75rem' }}>
                                    Edited by James Green • 2 hours ago
                                </div>
                            </div>
                        </div>
                    </aside>
    ...
    return (
        ...
        >
            ...
            <div style={{ flex: 1, minWidth: 0, position: 'relative' }}>
                ...
                {block.type === 'h1' && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        <span style={{ fontSize: '1.25rem', color: 'var(--color-text-secondary)', opacity: 0.5 }}>
                            #
                        </span>
                        <input
                            type="text"
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                            ...
                            <div>
                                ...
                                <div style={{ fontSize: '0.75rem', color: 'var(--color-text-secondary)' }}>
                                    User: {block.recordingData.user} • Duration: {block.recordingData.duration} •{' '}
                                    {block.recordingData.eventsCount} events
                                </div>
                            </div>
                        </div>
