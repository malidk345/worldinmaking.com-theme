...
export function LemonUIShowcaseApp({ onBack }: { onBack?: () => void } = {}): JSX.Element {
    const [activeTab, setActiveTab] = useState<
        'buttons' | 'inputs' | 'pickers' | 'overlays' | 'cards' | 'feedback' | 'tokens'
    >('buttons')
    ...
    return (
        ...
        >
            {/* Top Header */}
            <div
                style={{ marginBottom: '2rem', borderBottom: '1px solid var(--border-3000)', paddingBottom: '1.5rem' }}
            >
                ...
                >
                    All 38+ PostHog Lemon UI components rendered unboxed, without artificial containers or card borders.
                    Direct 1:1 React implementations.
                </p>
                ...
                <div style={{ marginTop: '1.5rem' }}>
                    <LemonTabs
                        ...
                        tabs={[
                            {
                                key: 'buttons',
                                label: '1. Buttons & Triggers',
                                badge: <LemonBadge content="21" status="primary" />,
                            },
            ...
            {activeTab === 'buttons' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
                    <div>
                        ...
                        >
                            Primary, Secondary, Tertiary buttons across Default, Alt, and Danger statuses.
                        </p>
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem', alignItems: 'center' }}>
                            <LemonButton type="primary" status="default">
                                Primary Default
                            </LemonButton>
                            <LemonButton type="primary" status="alt">
                                Primary Alt
                            </LemonButton>
                            <LemonButton type="primary" status="danger">
                                Primary Danger
                            </LemonButton>

                            <LemonButton type="secondary" status="default">
                                Secondary Default
                            </LemonButton>
                            ...
                            <LemonButton type="tertiary" status="default">
                                Tertiary Default
                            </LemonButton>
                            <LemonButton type="tertiary" status="alt">
                                Tertiary Alt
                            </LemonButton>
                    ...
                    <div>
                        <h3 style={{ fontSize: '1.125rem', fontWeight: 700, marginBottom: '0.5rem' }}>
                            Sizes & Icon Combinations
                        </h3>
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem', alignItems: 'center' }}>
                            <LemonButton size="small" type="secondary" icon={<IconPlus />}>
                                Small Button
                            </LemonButton>
                            <LemonButton size="medium" type="secondary" icon={<IconGear />}>
                                Medium Button
                            </LemonButton>
                            <LemonButton size="large" type="secondary" icon={<IconNotebook />}>
                                Large Button
                            </LemonButton>
                    ...
                    <div>
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1.5rem', alignItems: 'center' }}>
                                ...
                                dropdown={{
                                    overlay: (
                                        <div style={{ width: '180px' }}>
                                            <LemonButton fullWidth icon={<IconInfo />}>
                                                View Details
                                            </LemonButton>
                                            <LemonButton fullWidth icon={<IconGear />}>
                                                Edit Settings
                                            </LemonButton>
                                            <LemonDivider />
                                            <LemonButton fullWidth status="danger" icon={<IconTrash />}>
                                                Delete
                                            </LemonButton>
                                        </div>
                                    ),
                            ...
                            <More
                                overlay={
                                    <div style={{ width: '160px' }}>
                                        ...
                                        <LemonButton fullWidth status="danger">
                                            Archive
                                        </LemonButton>
                                    </div>
                                }
                            ...
                            <LemonButton type="secondary" disabled disabledReason="Requires Admin privilege">
                                Disabled
                            </LemonButton>
                        </div>
                    </div>
            ...
            {activeTab === 'pickers' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
                    ...
                    <div>
                        <h3 style={{ fontSize: '1.125rem', fontWeight: 700, marginBottom: '1rem' }}>
                            Progress Indicators & Range Slider
                        </h3>
            ...
            {activeTab === 'overlays' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                    <div>
                        ...
                        >
                            Click below to trigger open fullscreen overlays.
                        </p>
                        <div style={{ display: 'flex', gap: '1rem' }}>
                            <LemonButton type="primary" onClick={() => setModalOpen(true)}>
                                Open Lemon Modal
                            </LemonButton>
                            <LemonButton type="secondary" onClick={() => setDrawerOpen(true)}>
                                Open Side Drawer
                            </LemonButton>
                        </div>
                    </div>
                    ...
                    <LemonModal
                        ...
                        footer={
                            <>
                                <LemonButton type="tertiary" onClick={() => setModalOpen(false)}>
                                    Cancel
                                </LemonButton>
                                <LemonButton type="primary" onClick={() => setModalOpen(false)}>
                                    Save Flag
                                </LemonButton>
                            </>
                        }
                    ...
                    {/* Interactive Drawer */}
                    <LemonDrawer isOpen={drawerOpen} onClose={() => setDrawerOpen(false)} title="Insight Configuration">
            ...
            {activeTab === 'cards' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                    <div>
                        <h3 style={{ fontSize: '1.125rem', fontWeight: 700, marginBottom: '1rem' }}>
                            LemonTable Component
                        </h3>
                        <LemonTable
                            columns={[
                                {
                                    title: 'User / Distinct ID',
                                    dataIndex: 'user',
                                    render: (val) => <ProfilePicture name={val} showName />,
                                },
                                {
                                    title: 'Role',
                                    dataIndex: 'role',
                                    render: (val) => <LemonTag type="highlight">{val}</LemonTag>,
                                },
                                {
                                    title: 'Status',
                                    dataIndex: 'status',
                                    render: (val) => <LemonBadge content={val} status="success" />,
                                },
                                {
                                    title: 'Actions',
                                    key: 'actions',
                                    render: () => <More overlay={<LemonButton fullWidth>View Profile</LemonButton>} />,
                                },
                            ]}
                            dataSource={[
                    ...
                    <div>
                        ...
                        <div style={{ maxWidth: '640px' }}>
                            <LemonRow
                                ...
                                sideAction={
                                    <LemonButton size="small" type="tertiary">
                                        Edit
                                    </LemonButton>
                                }
                            />
                    ...
                    <div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                            <LemonBanner type="info">
                                New feature flag system is now active in your workspace.
                            </LemonBanner>
                            ...
                            <LemonBanner type="error">
                                Failed to connect to SeaweedFS object storage endpoint.
                            </LemonBanner>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                            <div>
                                ...
                                >
                                    Display / Hero Title (40px / 2.5rem • ExtraBold 800)
                                </div>
                                <div
                                    style={{
                                        fontSize: '2.5rem',
                                ...
                                >
                                    Product Analytics Built for Engineers
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                >
                                    H1 Scene Title (30px / 1.875rem • ExtraBold 800)
                                </div>
                                <div
                                    style={{
                                        fontSize: '1.875rem',
                                ...
                                >
                                    Notebooks & SQL Insights Overview
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                >
                                    H2 Section Title (24px / 1.5rem • SemiBold 700)
                                </div>
                                <div style={{ fontSize: '1.5rem', fontWeight: 700, lineHeight: 1.3 }}>
                                    Configure Experiment Variant Rules
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                >
                                    H3 Card Header (18px / 1.125rem • SemiBold 700)
                                </div>
                                <div style={{ fontSize: '1.125rem', fontWeight: 700, lineHeight: 1.4 }}>
                                    Session Replay Recording Filter
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                >
                                    Body Base / Default (14px / 0.875rem • Regular 400 & Medium 500)
                                </div>
                                <div style={{ fontSize: '0.875rem', fontWeight: 400, lineHeight: 1.5 }}>
                                    PostHog captures events, session recordings, and feature flags in real-time. Team
                                    isolation is enforced at the database layer using team_id scoped query filters.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                >
                                    Code / Monospace (13px / 0.8125rem • Font Mono)
                                </div>
                                <div
                                    style={{
                                ...
                                >
                                    SELECT event, count() FROM events WHERE team_id = 2 GROUP BY event ORDER BY count()
                                    DESC
                                </div>
                            </div>
                        </div>
