...
export function NotebooksListApp({ onSelectNotebook }: NotebooksListAppProps = {}): JSX.Element {
    ...
    const handleDelete = (id: string): void => setNotebooks((prev) => prev.filter((nb) => nb.id !== id))

    return (
        <div
            className="scene-content flex flex-col gap-y-4 relative z-10"
            style={{
                minHeight: '100vh',
                                    ...
                                    <tbody>
                                        {filtered.length === 0 ? (
                                            <tr>
                                                <td colSpan={5}>
                                                    <div
                                                        className="LemonTable__empty-state"
