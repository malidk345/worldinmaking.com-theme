...
export function IconCalculate(props: LemonIconProps): JSX.Element {
    return (
        <LemonIconBase {...props}>
            <path
                d="M19 3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3ZM13 7H18V9H13V7ZM13 11H18V13H13V11ZM6 6H11V8H6V6ZM6 10H11V12H6V10ZM6 14H11V19H6V14ZM13 15H18V19H13V15Z"
                fill="currentColor"
            />
        </LemonIconBase>
    )
