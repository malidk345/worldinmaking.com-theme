...
import KoreanMDXViewer from './KoreanMDXViewer'
        ...
        <div>
                    ...
                    <Tooltip trigger={<IconInfo className="size-4 text-primary inline-block" />}>
                        <div className="max-w-sm">
                            ...
                            <p className="text-sm mb-0">
                                <Link href="/wizard" state={{ newWindow: true }}>
            ...
            */}
            <p className="!text-sm flex items-center gap-2 mt-4 justify-center @xl:justify-start">
                ...
                <Link href="/demo" state={{ newWindow: true }} className="text-secondary hover:text-primary">
                ...
                <span className="text-secondary">•</span>
                <Link href="/talk-to-a-human" state={{ newWindow: true }} className="text-secondary hover:text-primary">
...
const Button = ({ url, children }: { url: string; children: React.ReactNode }) => (
    <Link href={url} state={{ newWindow: true }}>
        {children}
    </Link>
)
                ...
                {selectedStageData.products.map((item, idx) => {
                    ...
                    return (
                        <li key={idx} className="flex items-center gap-1.5">
                            ...
                            <Link href={`/${product?.slug}`} state={{ newWindow: true }} className="font-semibold">
