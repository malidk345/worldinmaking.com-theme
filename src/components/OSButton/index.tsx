...
export default function OSButton({
    ...
    const variantClasses = {
        ...
        primary: {
            ...
            child: 'flex items-center justify-center bg-orange text-white hover:text-white dark:text-white dark:hover:text-white no-underline border-button dark:border-button dark:bg-orange font-bold active:transition-all active:duration-100 select-none',
        },
        secondary: {
