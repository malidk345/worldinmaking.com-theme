...
import { LemonMenu } from 'components/LemonUI/LemonMenu'
...
class PostHogErrorBoundary extends Component<{ children: ReactNode }> {
    ...
    render() { return this.state.hasError ? <div className="p-4 text-xs text-red-400">Error rendering component</div> : (this.props.children as any) }
}
