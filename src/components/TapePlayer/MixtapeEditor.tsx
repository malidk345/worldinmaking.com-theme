        ...
        const loadMixtape = async () => {
            try {
                ...
                formik.setValues({
                    ...
                    cassetteColor: attributes.metadata?.cassetteColor || '#d5d6d1',
                    labelColor: attributes.metadata?.labelColor || '#e9eae5',
                })
            } catch (error) {
            ...
            >
                ...
                <form onSubmit={formik.handleSubmit} className="space-y-2 mb-0">
                    {isEditMode && shareUrl && (
                        <Fieldset
                            legend={
                                <Link href={shareUrl} state={{ newWindow: true }} className="flex items-center gap-1">
                                    <span>Share URL</span>
