            ...
            */}
            ...
            >
                <p className="text-center text-[15px] font-medium">
                    Curious how other teams use PostHog? <Link href="/customers">Read their stories.</Link>
                </p>
            </section>
            ...
            >
                ...
                <p className="text-center mb-2">
                    PostHog works in small teams. <Link href={teamSlug}>Here's the team</Link> responsible for building
