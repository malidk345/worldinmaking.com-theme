                ...
                >
                    ...
                    <section className="">
                        ...
                        <p className="text-center text-sm font-medium">
                            ...
                            <Link href={`/questions/${product.slug}`}>Ask the community</Link> or{' '}
                            <Link href="/talk-to-a-human">book a demo</Link>.
                        </p>
                    </section>
                    ...
                    <section id="docs" className="py-16">
                        ...
                        <p className="mt-0 text-opacity-70 text-center">
                            Get a more technical overview of how everything works <Link href="/docs">in our docs</Link>.
                        </p>
                        <DocLinks
                            menu={
                    ...
                    <section id="team">
                        ...
                        <p className="text-center mb-0">
                            PostHog works in small teams. The <Link href={teamSlug}>{team}</Link> team is responsible for
