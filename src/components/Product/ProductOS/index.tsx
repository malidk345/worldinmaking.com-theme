    ...
    return (
        <Tooltip content={name}>
            <span className="relative">
                <Link href={url} className={`inline-flex bg-${color}/10 text-${color} dark:text-${color} rounded p-2`}>
                    <span
            ...
            <div id="features">
                    ...
                    */}
                    ...
                    <div className="flex flex-col-reverse items-center md:flex-row gap-8 mb-20">
                        <div className="flex-1">
                            ...
                            <p>
                                We created <Link href="/docs/sql">SQL access</Link>, a translation layer over ClickHouse
                ...
                <section className="max-w-7xl mx-auto px-5 mb-10 md:mb-20">
                    ...
                    <p>
                        ...
                        <Link href="/docs">visit the docs</Link>.
                    </p>
                    <ul className="list-none p-0 grid md:grid-cols-4 gap-4 mb-10 md:mb-20">
                        <TextCard
                            title="Autocapture"
