...
export function MaxChatApp({ onClose, onMinimize, onMaximize, isMaximized }: MaxChatAppProps): JSX.Element {
    ...
    const handleSendMessage = async (text: string, mode: ChatMode, contextTagOverride?: string) => {
        ...
        try {
            ...
            const assistantMessage: Message = {
                id: `ast-${Date.now()}`,
                role: 'assistant',
                content: `Analyzed query **"${text}"** with mode **${mode.toUpperCase()}** and context **${
                    currentContextTag || 'Global Workspace'
                            ...
                            steps={[
                                {
                                    ...
                                    detail: attachedContext
                                        ? `Attached context: ${attachedContext.name}`
                                ...
                                },
                                {
                                    ...
                                    label:
                                        activeMode === 'search'
                                            ? 'Performing Google Search grounding'
                                            : 'Executing LLM inference model',
                                    detail:
                                        activeMode === 'search'
