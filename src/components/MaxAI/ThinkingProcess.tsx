...
export const ThinkingProcess: React.FC<ThinkingProcessProps> = ({ steps, thinkingTimeMs, isLive = false }) => {
                        ...
                        return (
                            <div key={step.id} className="space-y-0.5">
                                <div className="flex items-center gap-2 text-[12px]">
                                    ...
                                    {isCompleted && <Check className="w-3 h-3 text-blue ml-1 shrink-0 font-bold" />}
