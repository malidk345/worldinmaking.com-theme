...
import { IconExternal, IconSidePanel, IconPlus, IconCheck } from '@posthog/icons'
...
export const HeaderBar: React.FC<HeaderBarProps> = ({ onOpenContextPanel, onNewChat, isContextPanelOpen }) => {
    ...
    return (
        ...
        >
            ...
            <LemonButton type="tertiary" size="small" onClick={onNewChat} icon={<IconPlus />} title="New Chat" />
        </div>
    )
}
