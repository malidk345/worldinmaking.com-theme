...
export function LemonTable<T extends Record<string, any>, K extends BulkSelectionKey = BulkSelectionKey>({
    ...
    const location = routerValues?.location
    const searchParams = routerValues?.searchParams || {}
    const hashParams = routerValues?.hashParams
    ...
    const currentSorting =
        sorting ||
        internalSorting ||
        (useURLForSorting && searchParams && typeof searchParams[currentSortingParam] === 'string'
                                                                ...
                                                                >
                                                                    ...
                                                                    {column.sorter &&
                                                                        (() => {
                                                                            ...
                                                                            const order = (isActiveSort && currentSorting && 'order' in currentSorting)
                                                                            ...
                                                                            return (
                                                                                <Tooltip
                                                                                    title={() => {
                                                                                        ...
                                                                                        return `Click to ${
                                                                                            nextSorting && 'order' in nextSorting
                                                                                                ? nextSorting.order ===
                                                                                                  1
                                                                                                    ? 'sort ascending'
                                                                                                    : 'sort descending'
