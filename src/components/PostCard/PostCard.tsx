    ...
    return (
        <div className="w-full flex flex-col justify-between items-center">
            <div className="w-full rounded overflow-hidden flex items-center justify-center pt-4">
                <Link href={post.fields.slug} className="featured-post-img">
                    <img
            ...
            <div className="w-full py-4">
                <h2 className="text-2xl text-white font-sans normal-case my-1">
                    <Link href={post.fields.slug} className="text-white hover:text-white hover:underline">
                        {post.frontmatter.title}
                    </Link>
                </h2>
            ...
            {featured ? (
                ...
                <div className="flex flex-col mb-6">
                    <h5 className="mb-0 font-bold font-sans normal-case leading-tight">
                        <Link href={post.fields.slug} className="dark:text-primary-dark text-primary">
