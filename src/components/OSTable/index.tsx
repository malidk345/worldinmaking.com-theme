    ...
    return (
        ...
        >
            ...
            <ScrollArea fullWidth fadeX={fadeHorizontal}>
                ...
                >
                    <div
                        className={`text-primary inline-grid divide-x divide-y divide-border border-b border-primary text-[15px] [&>div]:px-2 rounded-md ${
                            width === 'full' ? 'w-full min-w-[650px]' : 'w-min'
                        } ${
