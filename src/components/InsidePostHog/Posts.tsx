...
const FeaturedPost = ({ attributes: { featuredImage, title, excerpt, post_category, slug } }: any) => {
    return (
...
const PostPreview = ({ attributes: { featuredImage, title, excerpt, post_category, slug } }: any) => {
    return (
        <Link
            to={slug}
