...
const FilterTag = ({ children }: { children: React.ReactNode }) => (
    <span className="inline-block px-1.5 py-0.5 text-xs rounded bg-accent text-secondary">{children}</span>
)
const InlineCode = ({ children }: { children: React.ReactNode }) => (
    <code className="px-1 py-0.5 text-xs rounded bg-accent">{children}</code>
)
