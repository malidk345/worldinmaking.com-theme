// LEGACY: PostHog Squeak/Strapi host — intentionally empty on WIM.
// Auth, community, profiles, notebooks all use Supabase (lib/wim-auth, supabaseCommunity).
// Prefer lib/squeak helpers for new code.
import { getSqueakApiHost } from './squeak'

export const SQUEAK_HOST = getSqueakApiHost()
