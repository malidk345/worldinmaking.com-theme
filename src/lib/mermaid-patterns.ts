/**
 * Pure pattern matching, regex, and string utilities for Mermaid diagrams.
 *
 * This file contains NO runtime `mermaid` module imports and is 100% safe
 * for Edge Runtime, Serverless, and Client environments.
 */
