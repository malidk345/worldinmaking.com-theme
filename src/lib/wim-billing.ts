...
export const BILLING_PLANS = {
    free: {
        ...
        dailyChatLimit: 400,
        features: [
            'Standart WIM AI Modelleri (Gemini Flash, Groq Qwen)',
            'Günde 400 mesaja kadar sohbet kotası',
            'Temel Not Defteri & Masaüstü araçları',
    ...
    pro: {
        ...
        dailyChatLimit: 3000,
        features: [
            'Gelişmiş Düşünce Modelleri (Claude 3.7 Sonnet Thinking, GPT-4o, Gemini 2.5 Pro)',
            'Çoklu Zihin Münazara Modu (Multi-Agent Debate)',
            'Kişisel Semantik Bellek (Geçmiş notları ve fikirleri hatırlama)',
            'Sınırsız Not Defteri Restrüktürasyonu & Dipnotlar',
            'Sınırsız Canlı Kod, React & Mermaid Artefaktı',
            'Günde 3.000 mesaja kadar yüksek kapasite',
            'Profilde "Pro Düşünür" Rozeti & Özel Masaüstü Temaları',
        ],
    },
}
