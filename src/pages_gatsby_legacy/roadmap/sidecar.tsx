...
// gatsby shim for: graphql, useStaticQuery
import React from 'react'
const groupBy = (arr: any[], fn: any) => arr.reduce((acc: any, item: any) => { const key = typeof fn === "function" ? fn(item) : item[fn]; (acc[key] = acc[key] || []).push(item); return acc; }, {})
