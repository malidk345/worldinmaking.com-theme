...
export const WINDOW_BG =
    'bg-white/40 dark:bg-[#0A0A0C]/70 backdrop-blur-[25px] saturate-[190%] transform-gpu reduce-transparency:!bg-primary reduce-transparency:backdrop-blur-none'
...
export const TASKBAR_BG = 'bg-white/40 dark:bg-[#0A0A0C]/70 backdrop-blur-[25px] saturate-[190%] transform-gpu'
