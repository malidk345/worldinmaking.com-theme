...
export const WINDOW_BG =
    'bg-primary/75 backdrop-blur-[25px] saturate-[190%] transform-gpu reduce-transparency:!bg-primary reduce-transparency:backdrop-blur-none'

/** Reader sidebar overlays */
export const PANEL_BG =
    'bg-primary/75 dark:bg-primary backdrop-blur-[25px] saturate-[190%] transform-gpu reduce-transparency:!bg-primary reduce-transparency:backdrop-blur-none'

/** Taskbar — always frosted; not tied to reduce transparency */
export const TASKBAR_BG = 'bg-primary/50 backdrop-blur-[25px] saturate-[190%] transform-gpu'
