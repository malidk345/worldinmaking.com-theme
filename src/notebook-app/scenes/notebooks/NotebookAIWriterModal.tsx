        ...
        <LemonModal isOpen={isOpen} onClose={onClose} width={640}>
            <div className="flex flex-col gap-3">
                ...
                <label
                    ...
                    className="input-like flex flex-col cursor-text border border-primary focus-within:border-primary bg-[var(--color-bg-fill-input,var(--color-bg-surface-secondary,#ffffff))] rounded-xl p-3"
                >
                    <textarea
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-primary text-[11px]">
                        <LemonSelect
                            value={mode}
