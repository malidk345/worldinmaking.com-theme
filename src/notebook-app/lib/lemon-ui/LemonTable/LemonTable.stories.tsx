                ...
                columns={[
                        ...
                        cellActions: (value) => (
                            <>
                                <LemonButton
                                    ...
                                    size="small"
                                    icon={<IconLink />}
                                    onClick={() => console.info(`Viewing profile for ${value}`)}
                                >
                                    View profile
                                </LemonButton>
                                <LemonButton fullWidth size="small" onClick={() => console.info(`Copying ${value}`)}>
                                    Copy name
                                </LemonButton>
                            </>
                        ),
                    },
                    {
                        ...
                        cellActions: (value, record) => (
                            <>
                                <LemonButton fullWidth size="small" onClick={() => console.info(`Filtering to ${value}`)}>
                                    Filter to {value}
                                </LemonButton>
                                <LemonDivider />
                                <LemonButton
                                    ...
                                    status="danger"
                                    icon={<IconTrash />}
                                    onClick={() => console.info(`Removing ${record.name}`)}
                                >
                                    Remove person
                                </LemonButton>
                            </>
                        ...
                        overlay={
                            <>
                                <LemonButton
                                    ...
                                    size="small"
                                    icon={<IconLink />}
                                    onClick={() => console.info(`Viewing ${record.name}'s profile`)}
                                >
                                    View profile
                                </LemonButton>
                                <LemonButton fullWidth size="small" onClick={() => console.info(`Editing ${record.name}`)}>
                                    Edit
                                </LemonButton>
                                <LemonDivider />
                                <LemonButton
                                    ...
                                    status="danger"
                                    icon={<IconTrash />}
                                    onClick={() => console.info(`Deleting ${record.name}`)}
                                >
                                    Delete
                                </LemonButton>
                            </>
                ...
                renderActions: (ctx) => (
                    <>
                        <LemonButton
                            type="secondary"
                            size="small"
                            onClick={() => console.info(`Editing ${ctx.selectedCount} person(s)`)}
                        >
                            Edit selected
                        </LemonButton>
                        <LemonButton
                            ...
                            size="small"
                            icon={<IconTrash />}
                            onClick={() => console.info(`Deleting ${ctx.selectedKeys.join(', ')}`)}
                        >
                            Delete selected
                        </LemonButton>
                    </>
