...
This enables intuitive preview of the component, along with snapshotting, but in code always use \`LemonMenu\`.`,
    ...
    args: {
        items: [
            { label: 'Alert', onClick: () => console.log('Hello there.') },
            { label: 'Do nothing' },
        ...
        items: [
            {
                title: 'Reptiles',
                items: [
                    { label: 'Cobra', onClick: () => console.log('Sssss') },
                    { label: 'Boa', onClick: () => console.log('Rrrrr') },
                ],
            },
            {
                title: 'Mammals',
                items: [
                    { label: 'Dog', onClick: () => console.log('Woof') },
                    { label: 'Cat', onClick: () => console.log('Meow') },
                ],
            },
            {
                title: 'Birds',
                items: [
                    { label: 'Eagle', onClick: () => console.log('Screech') },
                    { label: 'Owl', onClick: () => console.log('Hoot') },
                ],
            },
        ] as LemonMenuSection[],
    },
                ...
                items: [
                    {
                        ...
                        onClick: () => console.log('Twrmzlzktdzuntqniuqpmodxmokjwolbbf'),
                        status: 'danger',
                    },
                ],
            },
