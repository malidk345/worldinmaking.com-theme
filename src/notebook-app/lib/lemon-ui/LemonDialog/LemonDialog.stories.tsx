...
const meta: Meta<LemonDialogProps> = {
    ...
    args: {
        ...
        primaryButton: {
            children: 'Primary',
            onClick: () => console.info('Primary Clicked!'),
        },
        ...
        tertiaryButton: {
            children: 'Tertiary',
            onClick: () => console.info('Tertiary Clicked!'),
        },
    },
    parameters: {
        docs: {
...
export const Customised: Story = {
    args: {
        ...
        primaryButton: {
            ...
            status: 'danger',
            onClick: () => console.info('Organization Deleted!'),
        },
        ...
        tertiaryButton: {
            ...
            status: 'danger',
            onClick: () => console.info('Organization and all events deleted!'),
        },
    },
}
