            ...
            <div>
                ...
                <div className="flex gap-2 flex-wrap">
                    <LemonTagComponent
                        icon={<IconFlag />}
                        closeOnClick
                        onClose={() => console.info('Tag closed!')}
                        type="primary"
                    >
                    ...
                    <LemonTagComponent
                        icon={<IconInfo />}
                        closeOnClick
                        onClose={() => console.info('Info tag closed!')}
                        type="highlight"
                    >
                        Info tag
                    </LemonTagComponent>
                    <LemonTagComponent
                        icon={<IconFlag />}
                        closeOnClick
                        onClose={() => console.info('Warning tag closed!')}
                        type="warning"
                        size="small"
                    >
                        Small warning
            ...
            <div>
                ...
                <div className="flex gap-2 flex-wrap">
                    <LemonTagComponent
                        icon={<IconFlag />}
                        closable
                        onClose={() => console.info('Regular tag closed!')}
                        type="primary"
                    >
                        Regular closable
                    </LemonTagComponent>
                    <LemonTagComponent closable onClose={() => console.info('No icon tag closed!')} type="highlight">
                        No icon closable
                    </LemonTagComponent>
                </div>
            </div>
