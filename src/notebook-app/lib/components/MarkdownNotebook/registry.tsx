...
export function getMarkdownNotebookDefaultRegistry(): NotebookComponentRegistry {
    return createMarkdownNotebookRegistry([
        ...
        makeDefinition({
            ...
            aliases: ['columns', 'split', 'side by side'],
            icon: <IconCollapse />,
            defaultProps: { left: '', right: '' },
            bare: true,
            hideModeActions: true,
            exclusiveEditPanel: true,
            ViewComponent: ColumnsBlock,
            EditComponent: ColumnsBlock,
            insertCommand: {},
        }),
        makeDefinition({
            tagName: 'Sketch',
            label: 'Sketch',
            category: 'Media',
            description: 'A small drawing on the page',
            aliases: ['draw', 'whiteboard', 'canvas'],
            icon: <IconPencil />,
            defaultProps: { strokes: '[]' },
            bare: true,
            hideModeActions: true,
            exclusiveEditPanel: true,
            ViewComponent: SketchBlock,
            EditComponent: SketchBlock,
            insertCommand: {},
        }),
        makeDefinition({
            tagName: 'Divider',
