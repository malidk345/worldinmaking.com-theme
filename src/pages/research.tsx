...
function PublicationCard({ paper }: { paper: ResolvedPublication }) {
    ...
    return (
        <div className="pl-4 border-l-2 border-primary space-y-1">
            ...
            <Link href={paper.url} external className="text-base font-bold text-primary">
                {paper.title}
            </Link>
...
const FAQ_ITEMS = [
    ...
    },
    {
        ...
        content: (
            <p>
                We're hiring{' '}
                <Link href="/careers/ai-research-engineer" state={{ newWindow: true }} className="underline">
