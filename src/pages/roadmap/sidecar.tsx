            ...
            <div className="">
                ...
                >
                    ...
                    <div className="article-content px-5 lg:px-12 w-full transition-all lg:max-w-3xl mx-auto pb-6">
                        ...
                        <ol>
                            <li>
                                Join our <Link href="/slack">community chat</Link>, and join the #team-website-and-docs
                        ...
                        <p>
                            For feedback, please join our <Link href="/slack">community chat</Link>, and post it in the
                            #team-website-and-docs channel.
                        </p>
                        <p>
                            For bugs, <Link href="https://github.com/PostHog/sidecar/issues/new">create an issue</Link> in
                            the Sidecar repo
                        </p>
                        <p>
                            To contribute code, we're grateful for{' '}
                            <Link href="https://github.com/PostHog/sidecar">pull requests in the sidecar repo</Link>. To
