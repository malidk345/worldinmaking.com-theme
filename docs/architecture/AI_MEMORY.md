...
- **Scope:** Audit bugs 2, 7, 8, 9, 10, 12 + DOI-shaped queries + retracted papers. Branch from `main` (`eeec21ed`), not stacked on #844. No Supabase, no quota logic, no fonts / wallpapers / animations.
